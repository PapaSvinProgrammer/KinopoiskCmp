...
interface MovieService {
    ...
    suspend fun getMoviesByFilter(queryParameters: List<Pair<String, String>>): Result<List<MovieDto>>
    suspend fun getRandomMovie(queryParameters: List<Pair<String, String>>): Result<MovieDto>
}